...
#     Position 5 is Final Grade, and Position 6 is Final Letter Grade. 
#     The group of students lists are in the larger "outer" list.
...
def read_data_file():
    ...
    lines = datafile.readlines()       # Reads the entire file into a variable called lines.
    for i in lines:
        stu.append(i.split(","))       # Split the data by commas and add each to the list.
    datafile.close()
...
def calculate_grades():
    ...
    for i in range(len(stu)):
        ...
        gradestotal = gradestotal + finalgr # Add the grade to the total for calculating the average.
...
def create_report_file():
    ...
    repfile.write("******************* CSC 230 Grade Report *******************")
