...
def display_results():
    ...
    print('Federal Income Tax Rate        $ ' + format(fed_inc_tax, '10,.2f'))
    print('State Income Tax Rate          $ ' + format(state_inc_tax, '10,.2f'))
    print('Social Security Tax Rate       $ ' + format(ss_tax, '10,.2f'))
    print('Medicare Tax Rate              $ ' + format(medic_tax, '10,.2f'))
